                  ...
                  <ul className="grid grid-cols-1 lg:grid-cols-2 gap-[30px]">
                    {experience.items.map((items, index) => (
                      ...
                      >
                        ...
                        <h3 className="text-xl max-w-[260px] min-h[60px] text-center lg:text-left">{items.title}</h3>
                        <div >
                      ...
                      <TooltipProvider delayDuration={100}>
                        <Tooltip>
                          <TooltipTrigger className="w-full h-[150px] bg-[#232329] rounded-xl flex justify-center items-center group "> 
                            <div className="text-6xl group-hover:text-accent trasition-all duration-500">{skill.icon}</div>
                          </TooltipTrigger>
                          <TooltipContent>
